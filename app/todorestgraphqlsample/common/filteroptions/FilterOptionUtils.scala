package todorestgraphqlsample.common.filteroptions
...
object FilterOptionUtils {
  ...
  ): Seq[FilterOptions[Tables.Todo, _]] = {
    val filterOptionsConfig = new FilterOptionsConfig
    filterOptionsConfig.todosFilterOptions
  ...
  def queryStringToFilterOptions(implicit
    queryString: Map[String, Seq[String]]
  ): Seq[FilterOptions[Tables.Todo, _]] = queryStringToOptionsSequence(queryString)
