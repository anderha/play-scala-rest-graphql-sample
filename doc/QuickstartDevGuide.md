...
4. Create a new [DAO](./DaoDoc.md) in __./app/db/*__ extending from [BaseSlickDAO](../app/de/innfactory/todorestgraphqlsample/common/daos/BaseSlickDAO.scala). See the example DAOs for usage. 
